...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-start justify-content-md-between mb-3">
            <h3 class="text-center"><strong>{{ __('Create New Locations') }}</strong></h3>
                    ...
                    <div class="card-body">
                        <form action="{{ route('locations.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea id="address" name="address" class="form-control" placeholder="Location Address" required>{{ old('address') }}</textarea>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <textarea id="gmap_embed_url" name="gmap_embed_url" rows="12" class="form-control"
                                    placeholder="Location Google Maps URL" required>{{ old('gmap_embed_url') }}</textarea>
                            </div>
